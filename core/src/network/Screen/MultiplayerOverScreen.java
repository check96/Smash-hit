...
public class MultiplayerOverScreen implements Screen
{
	...
	public MultiplayerOverScreen(GameManager _game)
	{
		game = _game;
		...
		back.setSize(200, 80);
		back.setPosition(GameConfig.Screen_Width*280/GameConfig.width, GameConfig.Screen_Height*50/GameConfig.height);
